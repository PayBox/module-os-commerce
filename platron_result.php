...
if($arrRequest['pg_result'] == 1)
	Order::process((int)$arrRequest['pg_order_id'], MODULE_PAYMENT_PLATRON_ORDER_PAYD_STATUS_ID);
else
	Order::process((int)$arrRequest['pg_order_id'], MODULE_PAYMENT_PLATRON_ORDER_FAIL_STATUS_ID);
